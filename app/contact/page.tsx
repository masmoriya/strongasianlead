    ...
    <>
      ...
      <section className="pb-20">
        <div className="page-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="relative aspect-square max-w-xs bg-soft p-8 dark:bg-white/5">
            <Image src={logo.square} alt="Strong Asian Lead logo" fill sizes="320px" className="object-contain p-8" />
          </div>
          <div className="grid gap-6">
            {links.map((link) => (
              <a key={link.href} href={link.href} target="_blank" rel="noreferrer" className="group border-t border-black/10 pt-5 dark:border-white/10">
