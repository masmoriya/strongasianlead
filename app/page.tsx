  ...
  return (
    <>
      <section className="relative min-h-[calc(100vh-64px)] overflow-hidden bg-black text-white">
        ...
        <div className="page-shell relative flex min-h-[calc(100vh-64px)] items-end pb-16 pt-24">
          <div className="max-w-3xl">
            <div className="relative mb-8 h-16 w-80 max-w-full">
            ...
            <div className="mt-8 flex flex-wrap gap-4 text-sm font-semibold">
              <Link href="/galleries" className="bg-gold px-5 py-3 text-ink">View galleries</Link>
              <a href={site.filmclusive} target="_blank" rel="noreferrer" className="border border-white/40 px-5 py-3 text-white">Filmclusive</a>
            </div>
          </div>
        </div>
      </section>
